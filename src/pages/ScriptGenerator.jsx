/**
 * @fileoverview AI script generator page.
 * Walks the user through a guided questionnaire (fetched from Supabase) based on
 * the Authority Alignment framework. On completion, sends answers to the Claude API
 * via /api/generate-script and displays the generated pitch script. Saves the script
 * to Supabase and offers a direct path to the recording page with the script loaded.
 */
