...
export default function Share() {
  ...
  const platforms = [
    { id: 'instagram', name: 'Instagram', icon: '📷', steps: ['Open Instagram app', 'Tap + icon at the bottom', 'Select Post or Reel', 'Choose your video', 'Add caption and hashtags', 'Tap Share'], tips: ['Keep videos under 60 seconds', 'Use Reels for up to 90 seconds', 'Add 3-5 hashtags'] },
    ...
    <div className="share">
      <div className="share-inner">
        ...
        <div className="share-header">
          ...
          <p className="share-subtitle">Download your best take from Recordings, then follow the guide below to post it.</p>
        </div>
        {!selectedPlatform ? (
